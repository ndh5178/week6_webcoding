  ...
  return (
    <section style={panelStyle}>
      <header style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
        <span style={{ color: '#8fb3ff', fontSize: '12px', fontWeight: 700, letterSpacing: '0.08em' }}>
          INPUT ENTRY
        </span>
        <h2 style={{ margin: 0, fontSize: '24px' }}>CLI Panel</h2>
        <p style={{ margin: 0, color: '#93a7c4', fontSize: '14px', lineHeight: 1.6 }}>
          SQL 입력을 받고 실행 요청만 부모로 전달합니다. 실제 실행과 결과 처리는 이 패널 밖에서 이루어집니다.
        </p>
      </header>

      <div style={cardStyle}>
        <div style={{ marginBottom: '12px', fontSize: '14px', fontWeight: 700 }}>예제 SQL</div>
      ...
      <form onSubmit={handleSubmit} style={{ ...cardStyle, display: 'flex', flexDirection: 'column', gap: '14px', flex: 1 }}>
